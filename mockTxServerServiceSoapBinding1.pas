...
// WSDL     : http://192.168.3.206:8088/mockTxServerServiceSoapBinding?WSDL
// Encoding : UTF-8
// Version  : 1.0
// (07/14/2011 12:48:00 PM - 1.33.2.5)
// ************************************************************************ //

unit mockTxServerServiceSoapBinding1;
...
type
  ...
  // port      : TxServerPort
  // URL       : http://AOC:8088/mockTxServerServiceSoapBinding
  // ************************************************************************ //
...
const
  defWSDL = 'http://192.168.3.206:8088/mockTxServerServiceSoapBinding?WSDL';
  defURL  = 'http://AOC:8088/mockTxServerServiceSoapBinding';
