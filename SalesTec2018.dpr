...
uses
  ...
  untSignatureCapture1x5 in 'untSignatureCapture1x5.pas' {FrmeSignatureCapture1x5},
  untSignatureCapture4x3 in 'untSignatureCapture4x3.pas' {FrmeSignatureCapture4x3},
  UntGroupTabs in 'UntGroupTabs.pas' {FrmGroupTabs},
  UntStartNewTab in 'UntStartNewTab.pas' {FrmSartNewTab},
  UntAddEditButtons in 'UntAddEditButtons.pas' {FrmAddEditButtons},
  UntTips in 'UntTips.pas' {FrmTips},
  QueryReply in 'QueryReply.pas',
  UntCoopDiscountCard in 'UntCoopDiscountCard.pas' {FrmCoopDiscCard},
  untEvertec in 'untEvertec.pas' {FrmEvertec},
  untIpe in 'untIpe.pas',
  untWebReceipt in 'untWebReceipt.pas' {FrmWebReceipt},
  untValidateProds in 'untValidateProds.pas' {FrmValidateProds},
  untEbtOptions in 'untEbtOptions.pas' {FrmEbtOptions},
  untDuplicateTrans in 'untDuplicateTrans.pas' {FrmDuplicateTrans},
  untReprintType in 'untReprintType.pas' {FrmReprintType},
  untReprintSettle in 'untReprintSettle.pas' {FrmReprintSettle},
  untClientId in 'untClientId.pas' {FrmClientId},
  untFilters in 'untFilters.pas' {FrmFilters},
  UntSearchPatRx in 'UntSearchPatRx.pas' {FrmSearchPatRx},
  UntInventoryHandheld in 'UntInventoryHandheld.pas' {FrmHandheld},
  UntAttribDepartment in 'UntAttribDepartment.pas' {frmDepartmentAttributes},
