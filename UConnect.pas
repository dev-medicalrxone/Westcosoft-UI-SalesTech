...
uses Wlccdll, UData;//, UntData;
//, UData, UCommonObj;

{$R *.DFM}

procedure TFDialing.ButtonConnectClick(Sender: TObject);
Var
  ...
  begin
      ...
      If LErrorNo <> 1 then
        ...
        If LErrorNo <> 1 then
          ...
          //===============================================
             ComResult := ComVisa_Start(ComPort, Telefono, 1, '', SendText, '..\Data\Logfile.txt', 0, 1);
...
procedure TFDialing.BAbortClick(Sender: TObject);
Var
  NoPuerto: Integer;
begin
  NoPuerto := Data.TCreditDebitSetupModemComPort.Value;
...
procedure TFDialing.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;
