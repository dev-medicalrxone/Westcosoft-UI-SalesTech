...
// WSDL     : http://txportwst.txhubpr.com:9000/txserver/2?wsdl
// Encoding : UTF-8
// Version  : 1.0
// (07/14/2011 01:27:12 PM - 1.33.2.5)
// ************************************************************************ //
...
const
  //defWSDL = 'http://txportwst.txhubpr.com:9000/txserver/2?wsdl';
  defWSDL = 'http://txportws.txhubpr.com:9000/txserver/2?wsdl';
  //defURL  = 'https://txportwst.txhubpr.com:8443/txserver/2';//'http://txportws.txhubpr.com:9000/txserver/2';
  //defWSDL = 'http://192.168.3.254:9000/txserver/2?wsdl';
  //defURL  = 'http://192.168.3.254:9000/txserver/2';
...
var
  ...
  defURL: String;
begin
  //defURL := 'https://txportwst.txhubpr.com:8443/txserver/2';
